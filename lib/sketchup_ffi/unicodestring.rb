...
module SketchupFFI
  ...
  attach_function(:SUStringGetUTF8, [SUStringRef, :size_t, :string, :size_ptr], SUResult)
  attach_function(:SUStringGetUTF16, [SUStringRef, :size_t, :string, :size_ptr], SUResult)
